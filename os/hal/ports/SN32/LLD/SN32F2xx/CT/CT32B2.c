...
/*****************************************************************************
* Function    : CT32B2_ResetTimer
* Description : Reset of CT32B2 timer
* Input       : None
* Output      : None
* Return      : None
* Note        : None
*****************************************************************************/
void CT32B2_ResetTimer(void)
{
    //Set CT32B2 as the up-counting mode.
    SN_CT32B2->TMRCTRL = (mskCT32_CRST);

    // Wait until timer reset done.
    while (SN_CT32B2->TMRCTRL & mskCT32_CRST);
}
