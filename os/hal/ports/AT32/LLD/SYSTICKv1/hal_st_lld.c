...
#define ST_ENABLE_PAUSE()                   DEBUG->CTRL |= DEBUG_CTRL_TMR12_PAUSE
...
#define ST_ENABLE_PAUSE()                   DEBUG->CTRL |= DEBUG_CTRL_TMR13_PAUSE
...
#define ST_ENABLE_PAUSE()                   DEBUG->CTRL |= DEBUG_CTRL_TMR14_PAUSE
...
void st_lld_init(void) {
  ...
  AT32_ST_TMR->IDEN   = 0;
  AT32_ST_TMR->CTRL2  = 0;
  AT32_ST_TMR->SWEVT  = TMR_SWEVT_OVFSWTR;
  AT32_ST_TMR->CTRL1  = TMR_CTRL1_TMREN;
