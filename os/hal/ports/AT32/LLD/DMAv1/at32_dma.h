 ...
 * @{
 */
#define AT32_DMA_CTRL_RESET_VALUE   0x00000000U
...
#define AT32_DMA_CTRL_PWIDTH_HWORD  DMA_CTRL_PWIDTH_0
#define AT32_DMA_CTRL_PWIDTH_WORD   DMA_CTRL_PWIDTH_1
#define AT32_DMA_CTRL_MWIDTH_MASK   DMA_CTRL_MWIDTH
#define AT32_DMA_CTRL_MWIDTH_BYTE   0U
#define AT32_DMA_CTRL_MWIDTH_HWORD  DMA_CTRL_MWIDTH_0
#define AT32_DMA_CTRL_MWIDTH_WORD   DMA_CTRL_MWIDTH_1
#define AT32_DMA_CTRL_SIZE_MASK     (AT32_DMA_CTRL_PWIDTH_MASK |            \
...
#define dmaStreamDisable(dmastp) {                                          \
  (dmastp)->channel->CTRL &= ~(AT32_DMA_CTRL_FDTIEN |                       \
