...
#if AT32_SPI_USE_SPI1 &&                                                    \
    !AT32_DMA_IS_VALID_PRIORITY(AT32_SPI_SPI1_DMA_PRIORITY)
#error "Invalid DMA priority assigned to SPI1"
#endif

#if AT32_SPI_USE_SPI2 &&                                                    \
    !AT32_DMA_IS_VALID_PRIORITY(AT32_SPI_SPI2_DMA_PRIORITY)
#error "Invalid DMA priority assigned to SPI2"
#endif

#if AT32_SPI_USE_SPI3 &&                                                    \
    !AT32_DMA_IS_VALID_PRIORITY(AT32_SPI_SPI3_DMA_PRIORITY)
#error "Invalid DMA priority assigned to SPI3"
#endif

#if AT32_SPI_USE_SPI4 &&                                                    \
    !AT32_DMA_IS_VALID_PRIORITY(AT32_SPI_SPI4_DMA_PRIORITY)
