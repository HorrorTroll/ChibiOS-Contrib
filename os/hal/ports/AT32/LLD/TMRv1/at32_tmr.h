 ...
 * @{
 */
#define AT32_TMR_STCTRL_SMSEL_MASK          ((7U << 0) | (1U << 16))
...
#define AT32_TMR_CM1_C1OCTRL_MASK           ((7U << 4) | (1U << 16))
...
#define AT32_TMR_CM1_C2OCTRL_MASK           ((7U << 12) | (1U << 24))
...
#define AT32_TMR_CM2_C3OCTRL_MASK           ((7U << 4) | (1U << 16))
...
#define AT32_TMR_CM2_C4OCTRL_MASK           ((7U << 12) | (1U << 24))
