...
#if !defined(USB_CTRL_L2RES) && defined(USB_CTRL_GRESUME)
#define USB_CTRL_L2RES  USB_CTRL_GRESUME
#endif
 ...
 */
#if (!defined(AT32_USB_USB1_H_IRQ_PRIORITY) &&                           \
     (AT32_USB1_H_NUMBER != AT32_USB1_L_NUMBER)) || defined(__DOXYGEN__)
 ...
 * @brief   USB1 interrupt priority level setting.
 */
#if !defined(AT32_USB_USB1_L_IRQ_PRIORITY) || defined(__DOXYGEN__)
...
#if AT32_USB_USE_USB1 &&                                                    \
    (AT32_USB1_H_NUMBER != AT32_USB1_L_NUMBER) &&                         \
    !OSAL_IRQ_IS_VALID_PRIORITY(AT32_USB_USB1_H_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to USB H"
#endif

#if AT32_USB_USE_USB1 &&                                                    \
    !OSAL_IRQ_IS_VALID_PRIORITY(AT32_USB_USB1_L_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to USB L"
#endif

#if !defined(AT32_USB1_H_HANDLER)
#error "AT32_USB1_H_HANDLER not defined"
#endif

#if !defined(AT32_USB1_H_NUMBER)
#error "AT32_USB1_H_NUMBER not defined"
#endif

#if !defined(AT32_USB1_L_HANDLER)
#error "AT32_USB1_L_HANDLER not defined"
#endif

#if !defined(AT32_USB1_L_NUMBER)
#error "AT32_USB1_L_NUMBER not defined"
#endif
 ...
 * @notapi
 */
#define usb_lld_get_frame_number(usbp) (AT32_USB->SOFRNUM & SOFRNUM_SOFNUM_MASK)
