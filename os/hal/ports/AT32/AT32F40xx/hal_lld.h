 ...
 *          - AT32F403AxC, AT32F407xC for Performance Low Density devices.
 *          - AT32F403AxE, AT32F407xE for Performance Medium Density devices.
 *          - AT32F403AxG, AT32F407xG for Performance High Density devices.
 *          .
 *
 * @addtogroup HAL
 * @{
...
#elif defined(AT32F403A_LD)
#define PLATFORM_NAME           "AT32F403A Performance Line Low Density"

#elif defined(AT32F403A_MD)
#define PLATFORM_NAME           "AT32F403A Performance Line Medium Density"

#elif defined(AT32F403A_HD)
#define PLATFORM_NAME           "AT32F403A Performance Line High Density"

#elif defined(AT32F407_LD)
#define PLATFORM_NAME           "AT32F407 Performance Line Low Density"

#elif defined(AT32F407_MD)
#define PLATFORM_NAME           "AT32F407 Performance Line Medium Density"

#elif defined(AT32F407_HD)
#define PLATFORM_NAME           "AT32F407 Performance Line High Density"
...
#if defined(AT32F403A_LD) || defined(AT32F403A_MD) ||                       \
    defined(AT32F403A_HD) || defined(AT32F407_LD)  ||                       \
    defined(AT32F407_MD)  || defined(AT32F407_HD)  ||                       \
    defined(__DOXYGEN__)
