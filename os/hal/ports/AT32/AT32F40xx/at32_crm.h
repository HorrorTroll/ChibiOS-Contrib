...
/**
 * @name    EMAC peripheral specific CRM operations
 * @{
 */
/**
 * @brief   Enables the EMAC peripheral clock.
 * @note    The @p lp parameter is ignored in this family.
 *
 * @param[in] lp        low power enable flag
 *
 * @api
 */
#define crmEnableEMAC(lp) crmEnableAHB(CRM_AHBEN_EMACEN |                  \
                                       CRM_AHBEN_EMACTXEN |                \
                                       CRM_AHBEN_EMACRXEN |                \
                                       CRM_AHBEN_EMACPTPEN, lp)

/**
 * @brief   Disables the EMAC peripheral clock.
 * @note    The @p lp parameter is ignored in this family.
 *
 * @param[in] lp        low power enable flag
 *
 * @api
 */
#define crmDisableEMAC() crmDisableAHB(CRM_AHBEN_EMACEN |                  \
                                       CRM_AHBEN_EMACTXEN |                \
                                       CRM_AHBEN_EMACRXEN |                \
                                       CRM_AHBEN_EMACPTPEN)

/**
 * @brief   Resets the EMAC peripheral.
 *
 * @api
 */
#define crmResetEMAC() crmResetAHB(CRM_AHBRST_EMACRST)
/** @} */
