 ...
 * @details HAL support for AT32 Performance Line LD, MD and HD sub-families.
 *
 * @ingroup HAL
 */
 ...
 * @brief   AT32F403A/F407 Performance Line HAL subsystem low level driver header.
 *
 ...
 * @{
 */
#define AT32_CLKOUT_SEL_PLLDIV4 ((1 << 16) | (AT32_CLKOUT_SEL_SCLK)) /*!< PLL/4 clock on CLKOUT_SEL pin. */
#define AT32_CLKOUT_SEL_USB     ((1 << 16) | (AT32_CLKOUT_SEL_HICK)) /*!< USB clock on CLKOUT_SEL pin. */
#define AT32_CLKOUT_SEL_ADC     ((1 << 16) | (AT32_CLKOUT_SEL_HEXT)) /*!< ADC clock on CLKOUT_SEL pin. */
