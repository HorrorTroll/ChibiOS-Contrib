...
/**
 * @file    AT32F40xx/at32_isr.c
 * @brief   AT32F40xx ISR handler code.
 *
...
#define exint_serve_irq(line, channel) {                                    \
                                                                            \
  if ((line) & (1U << (channel))) {                                         \
...
OSAL_IRQ_HANDLER(Vector58) {
  ...
  line = EXINT->LINE;
  line &= EXINT->INTEN & (1U << 0);
  EXINT->LINE = line;

  exint_serve_irq(line, 0);
...
OSAL_IRQ_HANDLER(Vector5C) {
  ...
  line = EXINT->LINE;
  line &= EXINT->INTEN & (1U << 1);
  EXINT->LINE = line;

  exint_serve_irq(line, 1);
...
OSAL_IRQ_HANDLER(Vector60) {
  ...
  line = EXINT->LINE;
  line &= EXINT->INTEN & (1U << 2);
  EXINT->LINE = line;

  exint_serve_irq(line, 2);
...
OSAL_IRQ_HANDLER(Vector64) {
  ...
  line = EXINT->LINE;
  line &= EXINT->INTEN & (1U << 3);
  EXINT->LINE = line;

  exint_serve_irq(line, 3);
...
OSAL_IRQ_HANDLER(Vector68) {
  ...
  line = EXINT->LINE;
  line &= EXINT->INTEN & (1U << 4);
  EXINT->LINE = line;

  exint_serve_irq(line, 4);
...
OSAL_IRQ_HANDLER(Vector9C) {
  ...
  line = EXINT->LINE;
  line &= EXINT->INTEN & ((1U << 5) | (1U << 6) | (1U << 7) | (1U << 8) |
                          (1U << 9));
  EXINT->LINE = line;

  exint_serve_irq(line, 5);
  exint_serve_irq(line, 6);
  exint_serve_irq(line, 7);
  exint_serve_irq(line, 8);
  exint_serve_irq(line, 9);
...
OSAL_IRQ_HANDLER(VectorE0) {
  ...
  line = EXINT->LINE;
  line &= EXINT->INTEN & ((1U << 10) | (1U << 11) | (1U << 12) | (1U << 13) |
                          (1U << 14) | (1U << 15));
  EXINT->LINE = line;

  exint_serve_irq(line, 10);
  exint_serve_irq(line, 11);
  exint_serve_irq(line, 12);
  exint_serve_irq(line, 13);
  exint_serve_irq(line, 14);
  exint_serve_irq(line, 15);
