...
/**
 * @file        AT32F40xx/cmparams.h
 * @brief       ARM Cortex-M4 parameters for the Artery AT32F40xx
 *
 * @defgroup    ARMCMx_AT32F40xx Artery AT32F40xx Specific Parameters
 * @ingroup     ARMCMx_SPECIFIC
 * @details     This file contains the Cortex-M4 specific parameters for the
 *              Artery AT32F40xx platform.
 * @{
 */
